...
;(function($){
    ...
    $.fn.PageBar = function(options){
         ...
         */
        function redPage(){
            var _pageSize = parseInt(opts.pageSize || 5);
            var _pageNo = parseInt(opts.pageNo || 1);
            var _totalCount = parseInt(opts.totalCount || 0);
            var _pageNum = parseInt(_totalCount%_pageSize == 0 ? _totalCount/_pageSize : _totalCount/_pageSize+1);
           ...
           forbidBtn();
             ...
             */
            function redPageBar(){ 
//				<div id="pageContainer" class="redPageCss">
//            		<span class="red-count">共<span class="red-text-emphasis">156</span>条</span>
//					<a href="#" class="red-prev"><i></i></a> 
...
//					<a href="#">5</a>
//					<a href="#">6</a> 
//					<a href="#" class="red-next disabled"><i></i></a>
//				</div>
                var str = "", prefixStr = "",suffixStr = "";
                
                prefixStr = "<a id='prev' class='red-prev' href='javascript:;'><i></i></a>";
                suffixStr = "<a id='next' class='red-next' href='javascript:;'><i></i></a>" +
                	"<span class='red-count'>共<span class='red-text-emphasis'>"+_totalCount+"</span>条</span>";
                if(_pageNum == 0){
                	str +="<a id='page"+_pageNo+"' class='active' href='javascript:;'>"+_pageNo+"</a>";
                }
                if(_pageNum > 0 && _pageNum <=5){
                    
                    for (var i=1; i < _pageNum+1; i++) {
                        if(_pageNo == i){
                            str +="<a id='page"+i+"' class='active' href='javascript:;'>"+i+"</a>";
                        }else{
                            str +="<a id='page"+i+"' href='javascript:;'>"+i+"</a>";
                        }
                    };
                ...
                if(_pageNum > 5){
                	var diff = _pageNum - _pageNo;
                	if(diff >= 5){
                		for (var i = _pageNo; i < _pageNo + 5; i++) {
                			if(_pageNo == i){
                				str +="<a id='page"+i+"' class='active' href='javascript:;'>"+i+"</a>";
                			}else{
                				str +="<a id='page"+i+"' href='javascript:;'>"+i+"</a>";
                		...
                		for (var j = _pageNum - 4; j <= _pageNum; j++) {
                			if(_pageNo == j){
                				str +="<a id='page"+j+"' class='active' href='javascript:;' >"+j+"</a>";
                			}else{
                				str +="<a id='page"+j+"' href='javascript:;' >"+j+"</a>";
                			}
                		};
